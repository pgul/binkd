...
Проще всего взять версию 1.0a-498 или старше: в этой версии требуемые binkd
...
"Cлужбы", нужное право даётся пользователю автоматически).
...
и пароль. Затем (для версии 0.9.x) нужно в редакторе реестра открыть указанную
ветку реестра и задать права на редактирование этой ветки пользователю fido.
