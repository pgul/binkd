...
сих пор не использовалась, нужно её установить. В некоторые мэйлеры возможность
упаковки нетмэйла в BSO предусмотрена разработчиками (например, T-mail, начиная
с версии 2500).
