...
Со всеми предложениями и замечаниями пишите: Stas Degteff 2:5080/102
    ...
    26. Обнаружил баг в binkd!
    27. Как связаться с разработчиками.
    28. Хочу сразу узнавать об изменениях в binkd!
...
BeeMail (win32; Stephen Proffitt, 1:105/10; http://beemail.gexonline.net/)
    ...
    - поддержка файла паролей стиля T-mail - начиная с 0.9.4
...
----------------------------------------------------------------------------
    ...
    Что означает диагностика "send: TCP/IP error (-10000)" и как это лечить?
...
удаленной стороне об аварийном завершении, например так:
    ...
    Чтобы сессия со стороны binkd не "зависала", начиная с версии 0.9.5
в нем реализован workaround с сообщением в лог:
    rerror: ENC DES/CBC 559 (Encrypted session not supported)
