...
----------------------------------------------------------------------------
    ...
    Это PID (Process ID) в многопоточных версиях binkd (например, в версиях для
юниксоподобных ОС) или TID (Thread ID) в малтитредовых версиях binkd (например,
в версиях для Windows и OS/2).
