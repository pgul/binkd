...
- придется сменить мэйлер.
    Например, в конфигурации мэйлера "T-mail" нужно указать:
...
упаковывалась в пакеты BSO. Если такая программа не использовалась, нужно её
установить. В некоторые мэйлеры возможность упаковки нетмэйла в BSO
предусмотрена разработчиками (например, T-mail, начиная с версии 2500).
